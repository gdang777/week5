...
class Student extends Person {
  ...
  bio() {
    ...
    // SUPER - method lets you call the bio() of super class within the bio() of student class.
  }
}
...
let newStudent = new Student('Gaurav', 'Loves to travel', 'gaurav@celltrader.ca');
